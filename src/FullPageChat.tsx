...
import type { BotProps } from 'anjin-embed'
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'anjin-fullchatbot': React.DetailedHTMLProps<
...
export const FullPageChat = ({ style, className, ...assignableProps }: Props) => {
  ...
  useEffect(() => {
    ;(async () => {
      await import('anjin-embed/dist/web.js')
    })()
  }, [])
  ...
  return <anjin-fullchatbot ref={ref} style={style} class={className} />
}
